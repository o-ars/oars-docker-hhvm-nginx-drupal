...
### ----- 3 - Install Packages ----- ###
### -------------------------------- ###
RUN apt-get -y install nginx php5-cli php5-mysql php5-gd php5-curl php-pear
...
ADD /config/drupal7.conf /etc/nginx/sites-available/drupal7.conf
